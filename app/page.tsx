  ...
  return (
    <main>
      <div className="flex flex-col justify-center items-center gap-7 mt-11">
        ...
        <Link href="/contests" className="flex gap-2 w-1/4 bg-gray-800 text-white rounded-2xl mt-5 p-3 items-center font-mono justify-center hover:bg-black">
          Let&#39;s Get Coding! <ArrowRight />
        </Link>
      </div>
      <div className="mt-12 flex justify-center items-center space-x-20">
        <div className="text-3xl font-mono w-1/2">
          Learn In The Most Exciting Way! 
          <div className="text-xl font-mono text-gray-500 mt-2"> 
            Discover knowledge through engaging, interactive, and immersive learning experiences!
          </div>
          <div className="text-xl font-mono text-gray-400 mt-2">
            With abundance of features, one will never get bored to hustle in the field of competitive coding!
          </div>
        </div>
        <div>
          <Image src="/CAC_CpmpIcon.svg" alt="." width="300" height="300" />
        </div>
      </div>
      <div>
        <CodeBox />
      ...
      <div className="mt-12 flex justify-center items-center gap-2 space-x-3 mx-10">
        <div className="text-2xl font-mono w-1/3">
          Success is not final,  
          <div className="text-sm font-mono text-gray-500 mt-2">
            Failure is not fatal. Its the effort that you put, that counts!
        ...
        <div className="text-2xl font-mono w-1/3">
          Once is not enough, buddy!   
          <div className="text-sm font-mono text-gray-500 mt-2">
            Keep trying till the very end. Its the effort that you put, that counts!
            ...
            With every level of questions conquered successfully, one can assure his or her preparedness for facing challenges out there!
          </div>
        </div>
        <div className="text-2xl font-mono w-1/3">
          You&#39;re not alone! We&#39;re with ya!
          <div className="text-sm font-mono text-gray-500 mt-2">
